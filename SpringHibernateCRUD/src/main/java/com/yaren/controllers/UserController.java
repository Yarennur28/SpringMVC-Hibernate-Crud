...
public class UserController {
    ...
    private ModelAndView getPageUserAdd() {
        ...
        return view; // users.jsp veya users.html sayfasını döndür
    }
    ...
    public String updateUser(@ModelAttribute("user") Users user) {
        ...
        return "redirect:/users/list"; // userForm.jsp veya userForm.html sayfasını döndür
    }
